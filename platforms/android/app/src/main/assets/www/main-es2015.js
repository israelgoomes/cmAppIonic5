...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | clientes-cliente-detalhe-cliente-detalhe-cliente-module */[__webpack_require__.e("default~clientes-cliente-detalhe-cliente-detalhe-cliente-module~clientes-clientes-module~email-email~0f1502de"), __webpack_require__.e("clientes-cliente-detalhe-cliente-detalhe-cliente-module")]).then(__webpack_require__.bind(null, /*! ./clientes/cliente/detalhe-cliente/detalhe-cliente.module */ "./src/app/clientes/cliente/detalhe-cliente/detalhe-cliente.module.ts")).then(m => m.DetalheClientePageModule)
    },
    {
        path: 'modal-cadastro-cliente',
        loadChildren: () => Promise.all(/*! import() | clientes-modal-cadastro-cliente-modal-cadastro-cliente-module */[__webpack_require__.e("default~clientes-clientes-module~clientes-modal-cadastro-cliente-modal-cadastro-cliente-module"), __webpack_require__.e("clientes-modal-cadastro-cliente-modal-cadastro-cliente-module")]).then(__webpack_require__.bind(null, /*! ./clientes/modal-cadastro-cliente/modal-cadastro-cliente.module */ "./src/app/clientes/modal-cadastro-cliente/modal-cadastro-cliente.module.ts"))
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | projetos-projeto-detalhe-projeto-detalhe-projeto-module */[__webpack_require__.e("default~clientes-cliente-detalhe-cliente-detalhe-cliente-module~clientes-clientes-module~email-email~0f1502de"), __webpack_require__.e("default~projeto-detalhe-projeto-detalhe-projeto-module~projetos-projeto-detalhe-projeto-detalhe-proj~41c0e70e")]).then(__webpack_require__.bind(null, /*! ./projetos/projeto/detalhe-projeto/detalhe-projeto.module */ "./src/app/projetos/projeto/detalhe-projeto/detalhe-projeto.module.ts")).then(m => m.DetalheProjetoPageModule)
    },
    {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".my-custom-menu {\n  --width: 500px;\n}\n\n.menu-color {\n  background-image: -webkit-gradient(linear, left top, left bottom, from(white), to(#527F76));\n  background-image: linear-gradient(to bottom, white, #527F76);\n  width: 100%;\n  padding: 0px;\n  height: 50%;\n  border-bottom: 1px solide #fff;\n  border-radius: 30px;\n  margin-bottom: 20px;\n}\n\n.circle {\n  background-color: #aaa;\n  border-radius: 50%;\n  width: 200px;\n  height: 200px;\n  overflow: hidden;\n  position: relative;\n  margin-left: 48px;\n  padding-left: 0px !important;\n}\n\nion-button {\n  border: none !important;\n}\n\nbutton.button-native {\n  border: none !important;\n}\n\n.origin {\n  margin-bottom: 30px;\n  text-align: center;\n  height: 45%;\n  background-image: -webkit-gradient(linear, left top, left bottom, from(white), to(#527F76));\n  background-image: linear-gradient(to bottom, white, #527F76);\n}\n\n.purple {\n  margin-bottom: 30px;\n  text-align: center;\n  height: 45%;\n  background-image: -webkit-gradient(linear, left top, left bottom, from(white), to(purple));\n  background-image: linear-gradient(to bottom, white, purple);\n}\n\n.blue {\n  margin-bottom: 30px;\n  text-align: center;\n  height: 45%;\n  background-image: -webkit-gradient(linear, left top, left bottom, from(white), to(blue));\n  background-image: linear-gradient(to bottom, white, blue);\n}\n\n.black {\n  margin-bottom: 30px;\n  text-align: center;\n  height: 45%;\n  background-image: -webkit-gradient(linear, left top, left bottom, from(white), to(black));\n  background-image: linear-gradient(to bottom, white, black);\n}\n\nsection#sec-02 {\n  padding-top: 20px;\n  height: 65%;\n  border-top-right-radius: 30px;\n  border-top-left-radius: 30px;\n  background-color: white;\n}\n\n#picture-position {\n  padding-top: 10px;\n}\n\nion-content {\n  --ion-background-color: white;\n}\n\nion-item ion-ripple-effect.md .hydrated {\n  background-color: white !important;\n}\n\nbutton.button-native {\n  border-bottom: 1px solid;\n}\n\n.item-native::after {\n  background-color: white;\n}\n\nion-ripple-effect {\n  background-color: white;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _services_usuario_service_usuario_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./services/usuario-service/usuario.service */ "./src/app/services/usuario-service/usuario.service.ts");
...
/* harmony import */ var _services_refresh_page_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./services/refresh-page.service */ "./src/app/services/refresh-page.service.ts");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, userSrvc, router, spinnerSrvc, refreshSrvc, menuCtrl) {
    ...
    initializeApp() {
        this.class = localStorage.getItem(_configHelper__WEBPACK_IMPORTED_MODULE_6__["configHelper"].storageKeys.color) != null ?
            localStorage.getItem(_configHelper__WEBPACK_IMPORTED_MODULE_6__["configHelper"].storageKeys.color) : 'origin';
    ...
    atualizaUser() {
        const user = JSON.parse(localStorage.getItem(_configHelper__WEBPACK_IMPORTED_MODULE_6__["configHelper"].storageKeys.user));
...
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
        ...
        _services_usuario_service_usuario_service__WEBPACK_IMPORTED_MODULE_5__["UsuarioService"],
        _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"],
        _services_spinner_service_spinner_service__WEBPACK_IMPORTED_MODULE_8__["SpinnerService"],
        _services_refresh_page_service__WEBPACK_IMPORTED_MODULE_9__["RefreshPageService"],
...
/* harmony import */ var _services_http_service_http_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./services/http-service/http.service */ "./src/app/services/http-service/http.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            ngx_ui_loader__WEBPACK_IMPORTED_MODULE_12__["NgxUiLoaderModule"].forRoot(configSpinner),
...
/* harmony import */ var _spinner_service_spinner_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../spinner-service/spinner.service */ "./src/app/services/spinner-service/spinner.service.ts");
...
let HttpService = HttpService_1 = class HttpService {
    constructor(httpClient, ngxService, spinnerSrvc) {
...
HttpService = HttpService_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"],
        ...
        _spinner_service_spinner_service__WEBPACK_IMPORTED_MODULE_5__["SpinnerService"]])
], HttpService);
...
module.exports = __webpack_require__(/*! C:\Users\lsrael\Desktop\Projetos\cmAppIonic5\src\main.ts */"./src/main.ts");
