  ...
  function srcAppProjetosProjetoDetalheProjetoDetalheProjetoPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function DetalheProjetoPage(route, router, util) {
        ...
        this.color = 0;
        this.class = localStorage.getItem(src_app_configHelper__WEBPACK_IMPORTED_MODULE_4__["configHelper"].storageKeys.color) != null ? localStorage.getItem(src_app_configHelper__WEBPACK_IMPORTED_MODULE_4__["configHelper"].storageKeys.color) : 'origin';
        this.colorOption = 0;
        this.leftStyle = {
          'border': 'none',
          'width': '28%',
