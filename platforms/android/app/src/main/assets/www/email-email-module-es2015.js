...
/* harmony import */ var src_app_services_utils_utils_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/utils/utils.service */ "./src/app/services/utils/utils.service.ts");
...
let EmailFormComponent = class EmailFormComponent {
    constructor(fb, clientSrvc, spinnerSrvc, utilSrvc) {
        this.fb = fb;
        ...
        this.class = localStorage.getItem(_configHelper__WEBPACK_IMPORTED_MODULE_3__["configHelper"].storageKeys.color) != null ?
            localStorage.getItem(_configHelper__WEBPACK_IMPORTED_MODULE_3__["configHelper"].storageKeys.color) : 'origin';
    ...
    loadEmails() {
        ...
        const user = JSON.parse(localStorage.getItem(_configHelper__WEBPACK_IMPORTED_MODULE_3__["configHelper"].storageKeys.user));
...
], EmailFormComponent.prototype, "emailData", void 0);
EmailFormComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-email-form',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./email-form.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/email/email-form/email-form.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./email-form.component.scss */ "./src/app/email/email-form/email-form.component.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
        _services_cliente_service_cliente_service__WEBPACK_IMPORTED_MODULE_4__["ClienteService"],
        _services_spinner_service_spinner_service__WEBPACK_IMPORTED_MODULE_5__["SpinnerService"],
        src_app_services_utils_utils_service__WEBPACK_IMPORTED_MODULE_6__["UtilsService"]])
], EmailFormComponent);
...
/* harmony import */ var _email_form_email_form_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./email-form/email-form.component */ "./src/app/email/email-form/email-form.component.ts");
...
/* harmony import */ var _services_email_service_email_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/email-service/email.service */ "./src/app/services/email-service/email.service.ts");
/* harmony import */ var _configHelper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../configHelper */ "./src/app/configHelper.ts");
/* harmony import */ var _services_spinner_service_spinner_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/spinner-service/spinner.service */ "./src/app/services/spinner-service/spinner.service.ts");
...
let EmailPage = class EmailPage {
    constructor(userSrvc, emailSrvc, spinnerSrvc, alertCtrl, utilSrvc) {
        ...
        this.emails = '';
        this.color = "primary";
        this.color = localStorage.getItem(_configHelper__WEBPACK_IMPORTED_MODULE_4__["configHelper"].storageKeys.color) != null ?
            localStorage.getItem(_configHelper__WEBPACK_IMPORTED_MODULE_4__["configHelper"].storageKeys.color) : 'primary';
    ...
    sendEmail(event) {
        ...
        this.emailSrvc.sendEmail(event).subscribe((v) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
...
EmailPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_usuario_service_usuario_service__WEBPACK_IMPORTED_MODULE_2__["UsuarioService"],
        _services_email_service_email_service__WEBPACK_IMPORTED_MODULE_3__["EmailService"],
        _services_spinner_service_spinner_service__WEBPACK_IMPORTED_MODULE_5__["SpinnerService"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["AlertController"],
        _services_utils_utils_service__WEBPACK_IMPORTED_MODULE_7__["UtilsService"]])
], EmailPage);
...
let EmailService = class EmailService {
    constructor(http) {
        this.http = http;
        this.url = `${src_app_configHelper__WEBPACK_IMPORTED_MODULE_3__["configHelper"].URL}/send-email`;
    }
    sendEmail(data) {
