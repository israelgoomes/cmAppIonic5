...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".logo {\n  width: 140px;\n  height: 200px;\n  margin-left: auto;\n  margin-right: auto;\n  text-align: center;\n}\n\n#sec-logo {\n  background-image: -webkit-gradient(linear, left top, left bottom, from(white), to(#527F76));\n  background-image: linear-gradient(to bottom, white, #527F76);\n  border-radius: 30px;\n  margin-bottom: 50px;\n}\n\nion-card {\n  background-image: -webkit-gradient(linear, left top, left bottom, from(white), to(#527F76));\n  background-image: linear-gradient(to bottom, white, #527F76);\n}\n\n.purple {\n  color: purple;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _services_utils_utils_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../services/utils/utils.service */ "./src/app/services/utils/utils.service.ts");
...
let ClientesPage = class ClientesPage {
    constructor(clienteSrvc, refreshSrvc, modalCtrl, spinnerSrvc, fb, utilSrvc, router) {
        ...
        this.color = localStorage.getItem(_configHelper__WEBPACK_IMPORTED_MODULE_3__["configHelper"].storageKeys.color) != null ?
            localStorage.getItem(_configHelper__WEBPACK_IMPORTED_MODULE_3__["configHelper"].storageKeys.color) : 'primary';
...
ClientesPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_cliente_service_cliente_service__WEBPACK_IMPORTED_MODULE_2__["ClienteService"],
        ...
        _services_utils_utils_service__WEBPACK_IMPORTED_MODULE_9__["UtilsService"],
