...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~clientes-cliente-detalhe-cliente-detalhe-cliente-module~clientes-clientes-module~projetos-pr~ee0bd910"], {
  ...
  function srcAppHeaderHeaderComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "#sec-logo {\n  background-image: -webkit-gradient(linear, left top, left bottom, from(white), to(#527F76));\n  background-image: linear-gradient(to bottom, white, #527F76);\n  border-radius: 30px;\n  margin-bottom: 50px;\n}\n\n.logo {\n  width: 140px;\n  height: 200px;\n  margin-left: auto;\n  margin-right: auto;\n}\n\nion-card {\n  background-image: -webkit-gradient(linear, left top, left bottom, from(white), to(#527F76));\n  background-image: linear-gradient(to bottom, white, #527F76);\n  height: 250px;\n  text-align: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppProjetosProjetoCadastroProjetoCadastroProjetoComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function CadastroProjetoComponent(clienteSrvc, fb, projetoSrvc, spinnerSrvc, modalCtrl, refreshSrvc) {
      ...
      _createClass(CadastroProjetoComponent, [{
        ...
        value: function salvar() {
          ...
          this.projetoSrvc.includesProject(this.projectForm.value).subscribe(function (data) {
            ...
            _this2.refreshSrvc.refreshProject.emit();
...
//# sourceMappingURL=default~clientes-cliente-detalhe-cliente-detalhe-cliente-module~clientes-clientes-module~projetos-pr~ee0bd910-es5.js.map